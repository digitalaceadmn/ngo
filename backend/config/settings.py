...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-!t!y25uu-ca2fs*snhp7@@uard+p99&mb5&u=zgt!vl%7*8q81')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='ngo_cms'),
        'USER': config('DB_USER', default='digitalace'),
        'PASSWORD': config('DB_PASSWORD', default='digitalace%321'),
...
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS',
    default='http://localhost:3000,http://127.0.0.1:3000,http://localhost:8000,http://127.0.0.1:8000,https://prankiran.org',
