    ...
    const handleSubmit = async () => {
        ...
        if (type === "doctor") {
            const mappedData: DoctorApplication = {
                ...
                current_hospital: formData["Current Hospital/Clinic"] ? String(formData["Current Hospital/Clinic"]) : undefined,
                ...
                preferred_consultation_mode: formData["Preferred Mode of Consultation"] ? String(formData["Preferred Mode of Consultation"]) : undefined,
            };
...
async function submitNGOApplication(data: NGOApplication, domain: string) {
    const response = await fetch(`/api/ngo-application/`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
async function submitSupportApplication(data: SupportApplication, domain: string) {
    const response = await fetch(`/api/support-application/`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
