        ...
        <section className="py-16 px-6 md:px-20 bg-soft-golden text-center text-gold">
            ...
            <div className="grid md:grid-cols-4 gap-8">
                ...
                <div className="p-8 bg-white rounded-2xl shadow-lg hover:scale-105 transition">
                    ...
                    <h3 className="text-xl font-semibold text-dark">Awareness</h3>
                ...
                <div className="p-8 bg-white rounded-2xl shadow-lg hover:scale-105 transition">
                    ...
                    <h3 className="text-xl font-semibold text-dark">Diagnosis</h3>
                    <p className="text-dark mt-2 text-sm">
                ...
                <div className="p-8 bg-white rounded-2xl shadow-lg hover:scale-105 transition">
                    ...
                    <h3 className="text-xl font-semibold text-dark">Treatment</h3>
                    <p className="text-dark mt-2 text-sm">
                ...
                <div className="p-8 bg-white rounded-2xl shadow-lg hover:scale-105 transition">
                    ...
                    <h3 className="text-xl font-semibold text-dark">Support</h3>
                    <p className="text-dark mt-2 text-sm">
